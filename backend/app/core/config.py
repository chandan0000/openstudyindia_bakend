...
class Settings(BaseSettings):
    ...
    # === Project ===
    PROJECT_NAME: str = "openstudyindia"
    ...
    LOGFIRE_SERVICE_NAME: str = "openstudyindia"
    ...
    POSTGRES_DB: str = "openstudyindia"
    ...
    # === CORS ===
    # Allow local development origins for web-based Flutter and frontend servers.
